                            ...
                            <div class="panel panel-primary tabs-style-2">
                                ...
                                <div class="panel-body tabs-menu-body main-content-body-right border">
                                    <div class="tab-content">
                                                    ...
                                                    <tbody>
                                                        @foreach ($invoices as $invoice)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{ $invoice->Amount_collection }}ج</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>قيمة الضريبة :</td>
                                                                <th scope="row">{{ $invoice->Value_VAT }}ج</th>
                                                                <td>الاجمالي مع الضريبة :</td>
                                                                <th scope="row"> {{ $invoice->Total }}ج</th>
                                                            ...
                                                            <tr>
                                                                <th scope="row">ملاحظات : {{ $invoice->note }} </th>
                                                            </tr>
                                                    </tbody>
                                                </table>
                                        ...
                                        @endforeach
                                        @foreach ($InvoicesDetales as $Detales)
                                                    ...
                                                    <table class="table center-aligned-table mb-0 table-hover"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>{{ $Detales->invoice_number }}</td>
                                                                <td>{{ $Detales->product }}</td>
                                                                <td>{{ $invoice->section->section_name }}</td>
                                                                @if ($Detales->Value_Status == 1)
                                                                    <td><span
                                                                            class="badge badge-pill badge-success">{{ $Detales->Status }}</span>
                                                                    </td>
                                                                @elseif($Detales->Value_Status == 2)
                                                                    <td><span
                                                                            class="badge badge-pill badge-danger">{{ $Detales->Status }}</span>
                                                                    </td>
                                                                @else
                                                                    <td><span
                                                                            class="badge badge-pill badge-warning">{{ $Detales->Status }}</span>
                                                                    </td>Detales
                                                                @endif
                                                                <td>{{ $Detales->Payment_Date }}</td>
                                                                <td>{{ $Detales->note }}</td>
                                                                <td>{{ $Detales->created_at }}</td>
                                                                <td>{{ $Detales->user }}</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
