        ...
        <div class="container">
            <div class="row">
                <div class="col-10 mx-auto">
                    <!--first-->
                    <form class="p-4 m-3 border bg-gradient-info" method="POST" action="{{ url('sections/update/' . $sections->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label for="cat">اسم القسم </label>
                            <!--show the cat what you want to edit-->
                            <input type="text" name="section_name" value="{{$sections->section_name}}" class="form-control" id="section_name">
                        </div>
